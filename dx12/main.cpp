					 ...
					 _In_ int       nCmdShow)
{
	...
	wcex.lpszClassName = L"DragonDX12Window";
	// Register window class.
	RegisterClassEx( &wcex );

	// Perform application initialization:
	HWND hWnd = CreateWindowEx( NULL, L"DragonDX12Window", L"Dragon DX12", WS_OVERLAPPEDWINDOW, 300, 300, 800, 600, nullptr, nullptr, hInstance, nullptr );
	if( !hWnd ) {
