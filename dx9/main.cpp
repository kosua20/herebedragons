					 ...
					 _In_ int       nCmdShow)
{
	...
	wcex.lpszClassName = L"DragonDX9Window";
	// Register window class.
	RegisterClassEx( &wcex );

	// Perform application initialization:
	HWND hWnd = CreateWindowEx( NULL, L"DragonDX9Window", L"Dragon DX9", WS_OVERLAPPEDWINDOW, 300, 300, 800, 600, nullptr, nullptr, hInstance, nullptr );
	if( !hWnd ) {
